	...
	<div id="gbox-grd">
		...
		<div id="newsletter">
			...
			<form name="myform">
				...
				<div>
				<br/>
					<a href="create.jsp"><font style="color: navy;"><B>Create New Manager</B>
					</font></a><BR /><br/> <a href="install.jsp"><font
					style="color: navy;"><B>Install New Truck</B></font></a> <br /><br/> <a
					href="findtruck.jsp"><style="color: navy;"><B>Search
							Truck</B></font></a>
					</div>		
